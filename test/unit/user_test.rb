...
class UserTest < ActiveSupport::TestCase
  ...
  def test_create
    ...
    u = User.new(:login => "newbob", :name => "bob", :password => "newpassword", :password_confirmation => "newpassword", :email => "newbob@mcbob.com" )
    assert_not_nil u.salt
  ...
  def test_protected_attributes
    ...
    u = User.new(:id=>999999, :salt=>"I-want-to-set-my-salt", :login => "badbob", :name => "bob", :password => "newpassword", :password_confirmation => "newpassword", :email => "badbob@mcbob.com" )
    assert u.save
